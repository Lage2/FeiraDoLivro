...
<meta charset="utf-8">
  ...
  <th>
  <font size=5> Remover Venda</font>
  </th>
  <th>
...
?>
<form name="senddata" method="post" enctype="multipart/form-data" action="removevenda.php">
<?php
...
<br><br><input name="enviar" type="submit" style="height: 50px; width: 150px" value="Remover livros"/></td><br><br>
