...
<br><font size=4><b> Atenção, esta opção não apaga os livros associados ao utlizador.</b></font>
<br><font size=4><b> Se o utilizador tiver livros não apagar!!!!!</b></font>

<form name="senddata" method="post" enctype="multipart/form-data" action="removeuser.php">
<input name="username" type="hidden" size="100" maxlength="98" value="<?php echo $username_user;?>"/>
<td><input name="enviar" type="submit" style="height: 50px; width: 150px" value="Remove Utilizador"/></td><br><br>
</form>
